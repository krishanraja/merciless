...
## 7. Genuine next cycle (NOT shipped blind, reasons)
XL interactive/auth/voice (full SVG chart wheel #7, Oracle proactive/voice/memory #8, onboarding rebuild+passwordless #10, time-scrub #15) need browser/voice QA. Push/PWA #16 + weekly digest #20 need SW/web-push/cron/Resend infra. Consented outreach #17 is Krish-gated behind a tested consent rate. Minor: recompute pre-rebuild charts; regenerate src/types/supabase.ts. See `_upgrade/merciless/PHASE-0.md`, `PHASE-1.md`.
